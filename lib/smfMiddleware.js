...
chkZone: function(req, res, next) {
	...
	// Check the zone is a valid zone. This is always the first piece of
	// middleware called, and it sets up the cache we use to carry things
	// around between middleware.
