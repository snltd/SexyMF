...
generated by running `node_modules/.bin/nodepw mypassword`. If you wish, you
can use clear text passwords instead. Authorizations are set with the
`auths` property, and are explained in the next section.

If you prefer wish to use authentication at all, set `use_auths` to `false`
